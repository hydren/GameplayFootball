...
static inline Stat create_stat(const std::string& name, float value) { Stat s = { name, value }; return s; }
...
void InitDefaultProfiles() {
  ...
  statsGK.push_back(create_stat("physical_balance", 0.6));
  statsGK.push_back(create_stat("physical_reaction", 0.8));
  statsGK.push_back(create_stat("physical_acceleration", 0.5));
  statsGK.push_back(create_stat("physical_velocity", 0.4));
  statsGK.push_back(create_stat("physical_stamina", 0.5));
  statsGK.push_back(create_stat("physical_agility", 0.6));
  statsGK.push_back(create_stat("physical_shotpower", 0.6));
  statsGK.push_back(create_stat("technical_standingtackle", 0.2));
  statsGK.push_back(create_stat("technical_slidingtackle", 0.2));
  statsGK.push_back(create_stat("technical_ballcontrol", 0.3));
  statsGK.push_back(create_stat("technical_dribble", 0.2));
  statsGK.push_back(create_stat("technical_shortpass", 0.6));
  statsGK.push_back(create_stat("technical_highpass", 0.7));
  statsGK.push_back(create_stat("technical_header", 0.2));
  statsGK.push_back(create_stat("technical_shot", 0.3));
  statsGK.push_back(create_stat("technical_volley", 0.2));
  statsGK.push_back(create_stat("mental_calmness", 0.5));
  statsGK.push_back(create_stat("mental_workrate", 0.5));
  statsGK.push_back(create_stat("mental_resilience", 0.5));
  statsGK.push_back(create_stat("mental_defensivepositioning", 0.9));
  statsGK.push_back(create_stat("mental_offensivepositioning", 0.1));
  statsGK.push_back(create_stat("mental_vision", 0.5));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_GK, statsGK));

  std::vector<Stat> statsSW;
  statsSW.push_back(create_stat("physical_balance", 0.7));
  statsSW.push_back(create_stat("physical_reaction", 0.7));
  statsSW.push_back(create_stat("physical_acceleration", 0.5));
  statsSW.push_back(create_stat("physical_velocity", 0.5));
  statsSW.push_back(create_stat("physical_stamina", 0.5));
  statsSW.push_back(create_stat("physical_agility", 0.4));
  statsSW.push_back(create_stat("physical_shotpower", 0.7));
  statsSW.push_back(create_stat("technical_standingtackle", 0.8));
  statsSW.push_back(create_stat("technical_slidingtackle", 0.8));
  statsSW.push_back(create_stat("technical_ballcontrol", 0.3));
  statsSW.push_back(create_stat("technical_dribble", 0.2));
  statsSW.push_back(create_stat("technical_shortpass", 0.4));
  statsSW.push_back(create_stat("technical_highpass", 0.4));
  statsSW.push_back(create_stat("technical_header", 0.6));
  statsSW.push_back(create_stat("technical_shot", 0.2));
  statsSW.push_back(create_stat("technical_volley", 0.2));
  statsSW.push_back(create_stat("mental_calmness", 0.5));
  statsSW.push_back(create_stat("mental_workrate", 0.5));
  statsSW.push_back(create_stat("mental_resilience", 0.5));
  statsSW.push_back(create_stat("mental_defensivepositioning", 0.8));
  statsSW.push_back(create_stat("mental_offensivepositioning", 0.2));
  statsSW.push_back(create_stat("mental_vision", 0.4));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_SW, statsSW));

  std::vector<Stat> statsD;
  statsD.push_back(create_stat("physical_balance", 0.8));
  statsD.push_back(create_stat("physical_reaction", 0.7));
  statsD.push_back(create_stat("physical_acceleration", 0.5));
  statsD.push_back(create_stat("physical_velocity", 0.5));
  statsD.push_back(create_stat("physical_stamina", 0.5));
  statsD.push_back(create_stat("physical_agility", 0.5));
  statsD.push_back(create_stat("physical_shotpower", 0.6));
  statsD.push_back(create_stat("technical_standingtackle", 0.8));
  statsD.push_back(create_stat("technical_slidingtackle", 0.8));
  statsD.push_back(create_stat("technical_ballcontrol", 0.5));
  statsD.push_back(create_stat("technical_dribble", 0.3));
  statsD.push_back(create_stat("technical_shortpass", 0.5));
  statsD.push_back(create_stat("technical_highpass", 0.5));
  statsD.push_back(create_stat("technical_header", 0.6));
  statsD.push_back(create_stat("technical_shot", 0.3));
  statsD.push_back(create_stat("technical_volley", 0.2));
  statsD.push_back(create_stat("mental_calmness", 0.5));
  statsD.push_back(create_stat("mental_workrate", 0.5));
  statsD.push_back(create_stat("mental_resilience", 0.5));
  statsD.push_back(create_stat("mental_defensivepositioning", 0.8));
  statsD.push_back(create_stat("mental_offensivepositioning", 0.3));
  statsD.push_back(create_stat("mental_vision", 0.6));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_D, statsD));

  std::vector<Stat> statsWB;
  statsWB.push_back(create_stat("physical_balance", 0.6));
  statsWB.push_back(create_stat("physical_reaction", 0.5));
  statsWB.push_back(create_stat("physical_acceleration", 0.6));
  statsWB.push_back(create_stat("physical_velocity", 0.6));
  statsWB.push_back(create_stat("physical_stamina", 0.5));
  statsWB.push_back(create_stat("physical_agility", 0.5));
  statsWB.push_back(create_stat("physical_shotpower", 0.5));
  statsWB.push_back(create_stat("technical_standingtackle", 0.7));
  statsWB.push_back(create_stat("technical_slidingtackle", 0.7));
  statsWB.push_back(create_stat("technical_ballcontrol", 0.5));
  statsWB.push_back(create_stat("technical_dribble", 0.5));
  statsWB.push_back(create_stat("technical_shortpass", 0.7));
  statsWB.push_back(create_stat("technical_highpass", 0.7));
  statsWB.push_back(create_stat("technical_header", 0.5));
  statsWB.push_back(create_stat("technical_shot", 0.4));
  statsWB.push_back(create_stat("technical_volley", 0.3));
  statsWB.push_back(create_stat("mental_calmness", 0.5));
  statsWB.push_back(create_stat("mental_workrate", 0.5));
  statsWB.push_back(create_stat("mental_resilience", 0.5));
  statsWB.push_back(create_stat("mental_defensivepositioning", 0.6));
  statsWB.push_back(create_stat("mental_offensivepositioning", 0.4));
  statsWB.push_back(create_stat("mental_vision", 0.6));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_WB, statsWB));

  std::vector<Stat> statsDM;
  statsDM.push_back(create_stat("physical_balance", 0.7));
  statsDM.push_back(create_stat("physical_reaction", 0.6));
  statsDM.push_back(create_stat("physical_acceleration", 0.5));
  statsDM.push_back(create_stat("physical_velocity", 0.5));
  statsDM.push_back(create_stat("physical_stamina", 0.5));
  statsDM.push_back(create_stat("physical_agility", 0.5));
  statsDM.push_back(create_stat("physical_shotpower", 0.6));
  statsDM.push_back(create_stat("technical_standingtackle", 0.7));
  statsDM.push_back(create_stat("technical_slidingtackle", 0.6));
  statsDM.push_back(create_stat("technical_ballcontrol", 0.5));
  statsDM.push_back(create_stat("technical_dribble", 0.4));
  statsDM.push_back(create_stat("technical_shortpass", 0.7));
  statsDM.push_back(create_stat("technical_highpass", 0.7));
  statsDM.push_back(create_stat("technical_header", 0.5));
  statsDM.push_back(create_stat("technical_shot", 0.4));
  statsDM.push_back(create_stat("technical_volley", 0.3));
  statsDM.push_back(create_stat("mental_calmness", 0.5));
  statsDM.push_back(create_stat("mental_workrate", 0.5));
  statsDM.push_back(create_stat("mental_resilience", 0.5));
  statsDM.push_back(create_stat("mental_defensivepositioning", 0.6));
  statsDM.push_back(create_stat("mental_offensivepositioning", 0.4));
  statsDM.push_back(create_stat("mental_vision", 0.6));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_DM, statsDM));

  std::vector<Stat> statsM;
  statsM.push_back(create_stat("physical_balance", 0.4));
  statsM.push_back(create_stat("physical_reaction", 0.5));
  statsM.push_back(create_stat("physical_acceleration", 0.6));
  statsM.push_back(create_stat("physical_velocity", 0.6));
  statsM.push_back(create_stat("physical_stamina", 0.5));
  statsM.push_back(create_stat("physical_agility", 0.6));
  statsM.push_back(create_stat("physical_shotpower", 0.6));
  statsM.push_back(create_stat("technical_standingtackle", 0.4));
  statsM.push_back(create_stat("technical_slidingtackle", 0.3));
  statsM.push_back(create_stat("technical_ballcontrol", 0.7));
  statsM.push_back(create_stat("technical_dribble", 0.6));
  statsM.push_back(create_stat("technical_shortpass", 0.8));
  statsM.push_back(create_stat("technical_highpass", 0.7));
  statsM.push_back(create_stat("technical_header", 0.4));
  statsM.push_back(create_stat("technical_shot", 0.5));
  statsM.push_back(create_stat("technical_volley", 0.4));
  statsM.push_back(create_stat("mental_calmness", 0.5));
  statsM.push_back(create_stat("mental_workrate", 0.5));
  statsM.push_back(create_stat("mental_resilience", 0.5));
  statsM.push_back(create_stat("mental_defensivepositioning", 0.5));
  statsM.push_back(create_stat("mental_offensivepositioning", 0.5));
  statsM.push_back(create_stat("mental_vision", 0.7));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_M, statsM));

  std::vector<Stat> statsAM;
  statsAM.push_back(create_stat("physical_balance", 0.4));
  statsAM.push_back(create_stat("physical_reaction", 0.5));
  statsAM.push_back(create_stat("physical_acceleration", 0.6));
  statsAM.push_back(create_stat("physical_velocity", 0.6));
  statsAM.push_back(create_stat("physical_stamina", 0.5));
  statsAM.push_back(create_stat("physical_agility", 0.7));
  statsAM.push_back(create_stat("physical_shotpower", 0.7));
  statsAM.push_back(create_stat("technical_standingtackle", 0.2));
  statsAM.push_back(create_stat("technical_slidingtackle", 0.2));
  statsAM.push_back(create_stat("technical_ballcontrol", 0.6));
  statsAM.push_back(create_stat("technical_dribble", 0.7));
  statsAM.push_back(create_stat("technical_shortpass", 0.6));
  statsAM.push_back(create_stat("technical_highpass", 0.5));
  statsAM.push_back(create_stat("technical_header", 0.4));
  statsAM.push_back(create_stat("technical_shot", 0.7));
  statsAM.push_back(create_stat("technical_volley", 0.5));
  statsAM.push_back(create_stat("mental_calmness", 0.5));
  statsAM.push_back(create_stat("mental_workrate", 0.5));
  statsAM.push_back(create_stat("mental_resilience", 0.5));
  statsAM.push_back(create_stat("mental_defensivepositioning", 0.3));
  statsAM.push_back(create_stat("mental_offensivepositioning", 0.7));
  statsAM.push_back(create_stat("mental_vision", 0.4));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_AM, statsAM));

  std::vector<Stat> statsF;
  statsF.push_back(create_stat("physical_balance", 0.4));
  statsF.push_back(create_stat("physical_reaction", 0.5));
  statsF.push_back(create_stat("physical_acceleration", 0.7));
  statsF.push_back(create_stat("physical_velocity", 0.7));
  statsF.push_back(create_stat("physical_stamina", 0.5));
  statsF.push_back(create_stat("physical_agility", 0.7));
  statsF.push_back(create_stat("physical_shotpower", 0.7));
  statsF.push_back(create_stat("technical_standingtackle", 0.2));
  statsF.push_back(create_stat("technical_slidingtackle", 0.1));
  statsF.push_back(create_stat("technical_ballcontrol", 0.5));
  statsF.push_back(create_stat("technical_dribble", 0.8));
  statsF.push_back(create_stat("technical_shortpass", 0.6));
  statsF.push_back(create_stat("technical_highpass", 0.6));
  statsF.push_back(create_stat("technical_header", 0.4));
  statsF.push_back(create_stat("technical_shot", 0.7));
  statsF.push_back(create_stat("technical_volley", 0.4));
  statsF.push_back(create_stat("mental_calmness", 0.5));
  statsF.push_back(create_stat("mental_workrate", 0.5));
  statsF.push_back(create_stat("mental_resilience", 0.5));
  statsF.push_back(create_stat("mental_defensivepositioning", 0.25));
  statsF.push_back(create_stat("mental_offensivepositioning", 0.75));
  statsF.push_back(create_stat("mental_vision", 0.5));
  defaultProfiles.insert(std::pair< e_PositionName, std::vector<Stat> >(e_PositionName_F, statsF));

  std::vector<Stat> statsST;
  statsST.push_back(create_stat("physical_balance", 0.3));
  statsST.push_back(create_stat("physical_reaction", 0.6));
  statsST.push_back(create_stat("physical_acceleration", 0.6));
  statsST.push_back(create_stat("physical_velocity", 0.6));
  statsST.push_back(create_stat("physical_stamina", 0.5));
  statsST.push_back(create_stat("physical_agility", 0.7));
  statsST.push_back(create_stat("physical_shotpower", 0.8));
  statsST.push_back(create_stat("technical_standingtackle", 0.1));
  statsST.push_back(create_stat("technical_slidingtackle", 0.1));
  statsST.push_back(create_stat("technical_ballcontrol", 0.5));
  statsST.push_back(create_stat("technical_dribble", 0.7));
  statsST.push_back(create_stat("technical_shortpass", 0.5));
  statsST.push_back(create_stat("technical_highpass", 0.4));
  statsST.push_back(create_stat("technical_header", 0.6));
  statsST.push_back(create_stat("technical_shot", 0.8));
  statsST.push_back(create_stat("technical_volley", 0.7));
  statsST.push_back(create_stat("mental_calmness", 0.5));
  statsST.push_back(create_stat("mental_workrate", 0.5));
  statsST.push_back(create_stat("mental_resilience", 0.5));
  statsST.push_back(create_stat("mental_defensivepositioning", 0.2));
  statsST.push_back(create_stat("mental_offensivepositioning", 0.8));
  statsST.push_back(create_stat("mental_vision", 0.3));
...
void GetDefaultProfile(const std::vector<WeightedPosition> &weightedPositions, std::vector<Stat> &averageProfile) {
  ...
  averageProfile.push_back(create_stat("physical_balance", 0.0));
  averageProfile.push_back(create_stat("physical_reaction", 0.0));
  averageProfile.push_back(create_stat("physical_acceleration", 0.0));
  averageProfile.push_back(create_stat("physical_velocity", 0.0));
  averageProfile.push_back(create_stat("physical_stamina", 0.0));
  averageProfile.push_back(create_stat("physical_agility", 0.0));
  averageProfile.push_back(create_stat("physical_shotpower", 0.0));
  averageProfile.push_back(create_stat("technical_standingtackle", 0.0));
  averageProfile.push_back(create_stat("technical_slidingtackle", 0.0));
  averageProfile.push_back(create_stat("technical_ballcontrol", 0.0));
  averageProfile.push_back(create_stat("technical_dribble", 0.0));
  averageProfile.push_back(create_stat("technical_shortpass", 0.0));
  averageProfile.push_back(create_stat("technical_highpass", 0.0));
  averageProfile.push_back(create_stat("technical_header", 0.0));
  averageProfile.push_back(create_stat("technical_shot", 0.0));
  averageProfile.push_back(create_stat("technical_volley", 0.0));
  averageProfile.push_back(create_stat("mental_calmness", 0.0));
  averageProfile.push_back(create_stat("mental_workrate", 0.0));
  averageProfile.push_back(create_stat("mental_resilience", 0.0));
  averageProfile.push_back(create_stat("mental_defensivepositioning", 0.0));
  averageProfile.push_back(create_stat("mental_offensivepositioning", 0.0));
  averageProfile.push_back(create_stat("mental_vision", 0.0));
